...
const OVRAX_PRODUCTS = [
  ...
  {
    id: "smart-villa-study",
    title: "الدراسة الهندسية المتكاملة للفيلا الذكية (Smart Villa 3D)",
    category: "iot",
    categoryName: "المدن الذكية وإنترنت الأشياء",
    icon: "fa-house-signal",
    tag: "دراسة هندسية + 3D تفاعلي",
    tagType: "cyan",
    shortDesc: "دراسة هندسية وتطبيقية لفيلا سكنية (520 م²) مع استكشاف معماري 3D، جداول كميات (BOM)، ومخططات تمديدات وشبكات.",
    fullDesc: "منظومة دراسة هندسية تفاعلية شاملة لأتمتة فيلا سكنية فاخرة بمساحة 520 م² قائمة على الأتمتة المحلية (Local Edge Intelligence). تجمع بين نموذج تفاعلي ثلاثي الأبعاد مبني بمكتبة Three.js، كشف مسارات التمديدات الكهربائية والشبكية بالأشعة السينية (Wiring X-Ray)، محاكاة سيناريوهات يوم كامل (24-Hour Simulation)، وجدول حصر كميات ومواصفات تفصيلي (BOM).",
    features: [
      "مستكشف ثلاثي الأبعاد 3D تفاعلي لعزل الطوابق وفحص الأجهزة والتمديدات السلكية",
      "محاكاة تفاعلية لدورة اليوم الكامل (24-Hour Day) مع حركة الإضاءة والتكييف",
      "تصميم البنية التحتية للشبكات (كابينة 12U ومصفوفة VLANs) والتمديدات الكهربائية",
      "جدول كميات ومواصفات تفصيلي (BOM) مع الأسعار وحصر شامل للقطع الذكية"
    ],
    techStack: ["Three.js 3D", "Architecture UX", "IoT Protocols", "Interactive Blueprint"],
    price: "دراسة حية متكاملة",
    licenseType: "جاهز للمعاينة الفورية",
    demoType: "live-link",
    projectUrl: "projects/smart-villa-study/index.html"
  },
  {
    id: "luxury-furniture-store",
    title: "متجر قصر الفخامة للأثاث المنزلي والديكور الملكي",
    category: "retail",
    categoryName: "المتاجر الإلكترونية والتجزئة",
    icon: "fa-couch",
    tag: "متجر أثاث + لوحة تحكم",
    tagType: "amber",
    shortDesc: "منصة تجارة إلكترونية متكاملة لـ 50 قطعة أثاث منزلي فاخرة، مع سلة جانبية، حاسبة خصومات، ولوحة تحكم إدارية.",
    fullDesc: "متجر متكامل مصمم بنمط العمارة الخفيفة بدون خادم، يستعرض 50 قطعة أثاث راقية (غرف معيشة، نوم، طعام، مكاتب، وحدائق)، مزود بفلترة سريعة للأسعار والتصنيفات، سلة مشتريات جانبية تفاعلية مع حاسبة خصم تلقائي، نموذج إتمام طلب كامل، ولوحة إدارة (Admin Dashboard) للمخزون والمبيعات وتصدير البيانات.",
    features: [
      "كتالوج متكامل لـ 50 قطعة أثاث بمواصفات الأبعاد ونوع الخشب ومعارض صور",
      "لوحة إدارة متجر متكاملة (Admin Dashboard) لإدارة المنتجات، متابعة الطلبات، وتصدير البيانات JSON",
      "سلة تسوق جانبية منزلقة مع حاسبة أكواد خصم ومؤشر التوصيل والتركيب المجاني",
      "معالج إتمام طلب وفاتورة رقمية مع خيارات الدفع عند الاستلام، مدى، وتقسيط تابي وتمارا"
    ],
    techStack: ["JavaScript SPA", "LocalStorage DB", "Responsive CSS", "E-Commerce"],
    price: "واجهة حية متكاملة",
    licenseType: "جاهز للمعاينة الفورية",
    demoType: "live-link",
    projectUrl: "projects/luxury-furniture-store/index.html"
  },
  {
  ...
  },
  {
    ...
    categoryName: "إنترنت الأشياء والشبكات",
    icon: "fa-microchip",
    tag: "معرض حي لـ 20 نظاماً",
    tagType: "cyan",
    shortDesc: "منصة هندسية تطبيقية تضم 20 نظاماً متكاملاً (تخطيط القلب، الطقس، الرادار، الكاميرات، الطاقة) مع محاكيات حية وأكواد كاملة.",
    fullDesc: "موسوعة تطبيقية تفاعلية تم تطويرها كمنصة Static Web App متقدمة تشمل 20 مشروعاً تطبيقياً لأنظمة IoT؛ تتضمن أجهزة تخطيط القلب ECG، محطات الطقس، الرادارات، كاميرات المراقبة بالذكاء الاصطناعي، إدارة الطاقة، السدود والمياه، وأنظمة التتبع بالأقمار الصناعية، مدعمة بمحاكيات تفاعلية، جداول توصيل سلكي، قوائم المكونات BOM، وشفرات برمجية C++ كاملة.",
    features: [
      "20 نظاماً تطبيقياً ذكياً يغطي الرعاية الطبية، المدن الذكية، الأمن، والبيئة",
      "محاكيات تفاعلية بالوقت الفعلي مع إشارات تناظرية ورسوم بيانية ورادارات",
      "مخططات وجداول التوصيل السلكي الكاملة لـ ESP32 وحسابات المعالجة DSP",
      "شفرات برمجية إنتاجية C++ جاهزة للتحميل والتطبيق المباشر"
    ],
    techStack: ["ESP32 / C++", "Edge DSP", "IoT Sensors", "Tailwind CSS", "Interactive Canvas"],
    price: "واجهة حية متكاملة",
    licenseType: "جاهز للمعاينة الفورية",
    demoType: "live-link",
    projectUrl: "projects/ecg-iot-monitor/index.html"
  },
  {
